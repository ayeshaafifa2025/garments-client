...
    if (isLoading) {
        return <p className="text-center py-10 text-indigo-600">Loading all products for admin...</p>;
    }

    if (products.length === 0 && !searchTerm && !filterCategory) {
        return (
            <div className="text-center py-20">
                <p className="text-2xl text-gray-500 mb-4">No products found in the system.</p>
            </div>
        );
    }
...
                🛍️ All Products ({filteredProducts.length})
            </h1>
            
            
...
                            <th className="px-6 py-3 text-left text-xs font-bold text-indigo-700 uppercase tracking-wider">Created By</th> 
                            <th className="px-6 py-3 text-center text-xs font-bold text-indigo-700 uppercase tracking-wider">Show on Home</th>
...
                                    {product.managerName} <br/> 
                                    <span className='text-xs text-indigo-500'>{product.managerEmail}</span>
                                </td>
